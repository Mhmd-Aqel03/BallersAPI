...
public class UserService {
    ...
    public ArrayList<User> searchUsers(String username, Long currentUserId) {
        ...
        // Remove users who are not players or are the current user
        users.removeIf(user ->
                !user.getRole().equals(Role.ROLE_PLAYER) ||
