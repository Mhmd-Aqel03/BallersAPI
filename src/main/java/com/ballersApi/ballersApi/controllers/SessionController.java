...
public class SessionController {
    ...
    public ResponseEntity<SessionTeam> joinTeamSession(@PathVariable Long sessionId, @PathVariable Team team) {
        String username = SecurityContextHolder.getContext().getAuthentication().getName();
        Long playerId = userService.getUserByUsername(username).getId();
        SessionTeam teamSession = sessionTeamService.joinTeamSession(sessionId, playerId, team);
